...
\begin{itemize}
	\item développement cross-platform iOS/Android à l'aide de \otag{Flutter}
...
\begin{itemize}
	...
	\item développement iOS \otag{UIKit} en \otag{Swift} et Obj-C
	...
	\item design pattern MVVM, et utilisation de \otag{RxSwift}
